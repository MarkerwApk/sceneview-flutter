...
abstract class SceneNode with _$SceneNode {
  ...
  factory SceneNode.fromJson(Map<String, dynamic> json) => _$SceneNodeFromJson(json);
  ...
  SceneNode copyWithPose(Pose newPose) {
    return copyWith(position: newPose.translation, rotation: newPose.rotation);
  }
  ...
  SceneNode translate(Vector3 translation) {
    final newPose = Pose(translation: pose.translation + translation, rotation: pose.rotation);
    return copyWithPose(newPose);
  }

  SceneNode rotate(Quaternion rotation) {
    final newPose = Pose(translation: pose.translation, rotation: pose.rotation * rotation);
    return copyWithPose(newPose);
  }
